...
import com.example.usermanagementservice.dtos.ForgotPasswordRequestDto;
import com.example.usermanagementservice.dtos.ForgotPasswordResponseDto;
import com.example.usermanagementservice.dtos.LoginRequestDto;
import com.example.usermanagementservice.dtos.ResetPasswordRequestDto;
import com.example.usermanagementservice.dtos.SignUpRequestDto;
import com.example.usermanagementservice.dtos.UpdateProfileRequestDto;
...
public class AuthController {
    ...
    public ResponseEntity<UserDto> updateProfile(
        ...
        User user = authService.updateProfile(userId, token, updateDto.getName(), updateDto.getPhoneNumber(), updateDto.getAddress());
        return ResponseEntity.ok(from(user));
    }

    @PostMapping("/forgot-password")
    public ResponseEntity<ForgotPasswordResponseDto> forgotPassword(@RequestBody ForgotPasswordRequestDto forgotDto) {
        String resetToken = authService.forgotPassword(forgotDto.getEmail());
        ForgotPasswordResponseDto responseDto = new ForgotPasswordResponseDto();
        responseDto.setResetToken(resetToken);
